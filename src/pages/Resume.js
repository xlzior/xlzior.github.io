...
const Resume = () => (
  <Page title="Resume">
    ...
    <Anchor>
      ...
      <Anchor.Link href="#/resume/#competitions" title="Competitions" />
    </Anchor>
    
    <h2 id="/resume/#work-experience">Work Experience</h2>
    <Timeline data={work} />

    <h2 id="/resume/#projects"><Link to="/projects">Projects</Link></h2>
    <Timeline data={projects} isProject />

    <h2 id="/resume/#competitions">Competitions</h2>
